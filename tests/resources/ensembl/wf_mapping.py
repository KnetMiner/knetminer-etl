...
# Internal flag used by tests to distinguish these test elements from others generated by
# other tests. This is attached to all nodes and edges as the property `ketl:source`.
KETL_SOURCE = os.environ.get ( "KETL_SOURCE", "tests/ketl/snake/test_real_case.py" )
KETL_SOURCE_MAPPER = ConstantTripleMapper ( property = "ketl:source", constant_value = KETL_SOURCE )
